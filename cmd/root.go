...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.esgo-tools.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".esgo-tools" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".esgo-tools")
	}
